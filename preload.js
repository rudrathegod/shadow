...
contextBridge.exposeInMainWorld('shadow', {
  ...
  on: (channel, cb) => {
    const allowed = ['capture:state', 'llm:start', 'llm:token', 'llm:done', 'llm:error', 'status', 'stt:state', 'transcript', 'overlay:scroll', 'overlay:focus-input', 'overlay:panic', 'shortcuts:changed', 'update:progress'];
